...
knowledge0 = And(
    ...
    Or(Implication(AKnight, And(AKnight, AKnave)), Implication(AKnave, Not(And(AKnave, AKnight))))
...
knowledge3 = And(
    ...
    Or(Implication(AKnight, And(BKnave, CKnight)), Implication(BKnight,And(CKnave,AKnave))),
    Implication(AKnave,CKnave),
    Or(Not(And(AKnight,CKnight)), BKnight),
    Or(CKnight, AKnave),
